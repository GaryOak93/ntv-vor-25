...
void main(List<String> arguments) {
  ...
  String person = 'Kristján';
  print('Hæ $person, eigðu góðan dag!');
  ...
  anything new.'
  */
  String quote = "Þú getur ekki drepið mig því að hjartað mitt er hreint!";
  String author = "Tommi Kung fú";
  ...
  String capitalisedFirstName = firstName.substring(0,1).toUpperCase() + firstName.substring(1,firstName.length);
  String capitalisedLastName = lastName.substring(0,1).toUpperCase() + lastName.substring(1,lastName.length);
  String capitalisedFullName = '$capitalisedFirstName $capitalisedLastName';
  print(capitalisedFullName);
